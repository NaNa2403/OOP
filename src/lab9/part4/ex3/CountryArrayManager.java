...
public class CountryArrayManager {
    ...
    public boolean remove(Country country, int index) {
    ...
    public Country[] sortByIncreasingGdp() {
        ...
        for (int index = 1; index < newArray.length; index++) {
            ...
            while (tempIndex >= 0 && newArray[tempIndex].getGdp() > gdp) {
                newArray[tempIndex + 1] = newArray[tempIndex];
                tempIndex--;
            }
    ...
    public AfricaCountry[] filterAfricaCountry() {
        ...
        for (Country country : countries) {
            if (country != null && country.getClass().getSimpleName().equals("AfricaCountry")) {
    ...
    public AsiaCountry[] filterAsiaCountry() {
        ...
        for (Country country : countries) {
            if (country != null && country.getClass().getSimpleName().equals("AsiaCountry")) {
    ...
    public EuropeCountry[] filterEuropeCountry() {
        ...
        for (Country country : countries) {
            if (country != null && country.getClass().getSimpleName().equals("EuropeCountry")) {
    ...
    public NorthAmericaCountry[] filterNorthAmericaCountry() {
        ...
        for (Country country : countries) {
            if (country != null && country.getClass().getSimpleName().equals("NorthAmericaCountry")) {
    ...
    public OceaniaCountry[] filterOceaniaCountry() {
        ...
        for (Country country : countries) {
            if (country != null && country.getClass().getSimpleName().equals("OceaniaCountry")) {
    ...
    public SouthAmericaCountry[] filterSouthAmericaCountry() {
        ...
        for (Country country : countries) {
            if (country != null && country.getClass().getSimpleName().equals("SouthAmericaCountry")) {
